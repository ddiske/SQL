...
INSERT ALL
	INTO ACCOUNTS (ACCOUNTNUM, USERNAME, PRODUCTNUM) VALUES ('2', 'admin', 1)
	INTO ACCOUNTS (ACCOUNTNUM, USERNAME, PRODUCTNUM) VALUES ('3', '1', 1)
SELECT * FROM DUAL;
...
CREATE TABLE COMMENTS (
	BOARDNUM NUMBER,
	BOARDCONTENTS VARCHAR2(600) NOT NULL,
	BOARDDATE DATE DEFAULT SYSDATE NOT NULL,
	USERNAME VARCHAR2(200),
	PRODUCTNUM NUMBER,
	CONSTRAINT CN_PK PRIMARY KEY (BOARDNUM),
	CONSTRAINT C_U_FK FOREIGN KEY (USERNAME) REFERENCES USERS(USERNAME) ON DELETE SET NULL,
	CONSTRAINT C_P_FK FOREIGN KEY (PRODUCTNUM) REFERENCES PRODUCTS(PRODUCTNUM) ON DELETE SET NULL
)
...
VALUES (COMMENTS_SEQ.NEXTVAL, 'test', 'test', 1);

SELECT * FROM COMMENTS WHERE PRODUCTNUM = 3 ORDER BY BOARDNUM DESC;

DELETE COMMENTS WHERE PRODUCTNUM = 295;

SELECT * FROM (
	SELECT ROWNUM R, M.* FROM(
		SELECT * FROM COMMENTS
		WHERE PRODUCTNUM = 295
		ORDER BY BOARDNUM DESC
	) M
)
